"use client"; // أضفنا ده عشان الكومبوننت يترندر على الـ Client-Side
import React from "react";
import Image from "next/image";
import Link from "next/link"; // أضفنا Link بدل href في Button
    ...
    <footer className="bg-slate-100 dark:bg-gray-900 mt-10">
      <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8 lg:pt-24">
        <div className="text-center flex flex-col items-center justify-center">
          <Image src="/logo.png" width={150} height={150} alt="Website Logo" />
